...
class ChoicePromptDelegatePopupDialog extends Json implements ChoicePromptDelegateInterface
{
    ...
    protected CoreDouble $maxWidthFactor;
    ...
    public function setShadowColor(ColorInterface $shadowColor): self
    {
    ...
    public function setSurfaceTintColor(ColorInterface $surfaceTintColor): self
    {
    ...
    public function setMaxWidthFactor(CoreDouble $maxWidthFactor): self
    {
        $this->maxWidthFactor = $maxWidthFactor;
    ...
    {
        return 'ChoicePromptDelegatePopupDialog';
    }
}
